...
## 1. Request Parameters  
    ...
    Name: MODIS NDVI EVI CONUS 2023   

    Date Completed: 2024-03-19T15:44:29.041441  

    ID: e2caccd4-2c14-4b26-ba66-e9e06a67709c  
    ...
    Details:  
        ...
        Layers:  
                ...
                _1_km_monthly_blue_reflectance (MOD13A3.061)  
                _1_km_monthly_EVI (MOD13A3.061)  
                _1_km_monthly_MIR_reflectance (MOD13A3.061)  
                _1_km_monthly_NDVI (MOD13A3.061)  
                _1_km_monthly_NIR_reflectance (MOD13A3.061)  
                _1_km_monthly_pixel_reliability (MOD13A3.061)  
                _1_km_monthly_red_reflectance (MOD13A3.061)  
                _1_km_monthly_relative_azimuth_angle (MOD13A3.061)  
                _1_km_monthly_sun_zenith_angle (MOD13A3.061)  
                _1_km_monthly_VI_Quality (MOD13A3.061)  
                _1_km_monthly_view_zenith_angle (MOD13A3.061)  
      
        Output Projection:            Native Projection
        Output Format:                netcdf4  

    Version: This request was processed by AppEEARS version 3.48  

## 2. Request File Listing  

**Supporting Files:**  

- MODIS-NDVI-EVI-CONUS-2023-MOD13A3-061-metadata.xml
- MODIS-NDVI-EVI-CONUS-2023-granule-list.txt
- MODIS-NDVI-EVI-CONUS-2023-request.json
...
Total Size of Extracted Data Files: 1,714.28 MB  
...
- As of AppEEARS v3.47 (03/11/2024) GPW v4.11 `Data Quality Indicators` for `Basic Demographic Characteristics` is not returned by default. The `Data Quality Indicators` for the 2010 `Basic Demographic Characteristics` is available for request seperately.
...
- Didan, K. (2021). MODIS/Terra Vegetation Indices Monthly L3 Global 1km SIN Grid V061. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2024-03-19 from https://doi.org/10.5067/MODIS/MOD13A3.061. Accessed March 19, 2024.

## 10. Software Citation  

AppEEARS Team. (2024). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.48. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed March 19, 2024. https://appeears.earthdatacloud.nasa.gov
